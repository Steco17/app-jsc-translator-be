...
def train_translation_model(cleaned_input_sentences, cleaned_output_sentences):
    ...
    aligned_sentences = [
        ...
        for source, target in zip(cleaned_input_sentences, cleaned_output_sentences)
    ]
...
def translate(input_language, output_language, text_to_be_translated):
    ...
    # Train the model
    trained_model = train_translation_model(
        cleaned_input_sentences, cleaned_output_sentences
    )
