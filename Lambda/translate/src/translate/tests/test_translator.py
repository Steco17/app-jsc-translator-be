...
from translate.manage_globals.main import (
    translate,
)  # Assuming your translation module is named translation_module
...
class TestFlaskApp(unittest.TestCase):
    ...
    def test_translation(self):
        ...
        with app.test_request_context(
            "/translate?globalLang=english&localLang=spanish&dataText=hello"
        ):
